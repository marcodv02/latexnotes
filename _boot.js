...
ipcMain.handle('get-path', (event, pathType) => {
...
const { el_remote }= require('@electron/remote/main');

//el_remote.initialize();
...
const fontsDir = path.join(electron.app.getPath("userData"), "assets/fonts");
...
function createWindow(settings) {
    ...
    win = new BrowserWindow({
		...
		enableRemoteModule: true,
			...
			allowProposedApi: true,  // Abilita l'API proposta
